...
CFS Auto Loop Label is a <a href="https://wordpress.org/plugins/custom-field-suite/">Custom Field Suite</a> addon that takes the first textfield value of each loop and rename it's row. It's very useful when you don't want to have just a list of "Row name" labels in the post edit screen. If no textfield is find, it takes the first textarea value.
